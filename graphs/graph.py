...
def parsecsvdata():
    ...
    # open csv data
    with open("/home/student/mycode/graphs/2018summary.csv",\
     "r") as downtime:
...
def main():
    ...
    p3 = plt.bar(ind, newdata, width)
    # Describe the table metadata
    plt.ylabel("Length of Outage (mins)")
    plt.title("2018 Network Summary")
    plt.xticks(ind, ("Q1", "Q2", "Q3", "Q4"))
    plt.yticks(np.arange(0, 81, 10))
    plt.legend((p1[0], p2[0],p3[0]), ("LAN", "WAN", "new data"))

    # SAVE the graph locally
   # plt.savefig("/home/student/mycode/graphs/20182.png")
    # Save to "~/static"
    plt.savefig("/home/student/static/2018v3.png")       
    print("Graph created.")
